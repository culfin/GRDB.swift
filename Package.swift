...
// GRDB+SQLCipher: enabled for DateEye (skiptools/swift-sqlcipher for DB-03 cross-platform alignment)
dependencies.append(.package(url: "https://github.com/skiptools/swift-sqlcipher.git", from: "1.7.1"))
...
let package = Package(
    ...
    products: [
        // GRDBSQLite removed for SQLCipher build
        .library(name: "GRDB", targets: ["GRDB"]),
        .library(name: "GRDB-dynamic", type: .dynamic, targets: ["GRDB"]),
    ],
    dependencies: dependencies,
    targets: [
        // GRDBSQLCipher target removed — swift-sqlcipher provides GRDB helpers via grdb.h
        .target(
            name: "GRDB",
            dependencies: [
